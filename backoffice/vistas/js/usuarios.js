...
/*=============================================
FIRMA VIRTUAL ASSINATURA VIRTUAL
=============================================*/
...
$(".suscribirse").click(function(){
	...
	if(	nombre == ""||
		...
		$(".suscribirse").before(`<div class="alert alert-danger">Faltan datos, no ha aceptado o no ha firmado los términos y condiciones</div>`
			);
		return;
	}else{
